...
-- Add treesitter install directory to runtime path
-- Fixes "Install directory for parsers and queries is not in runtimepath" error
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Show git branch in the statusline (left side, after mode)
      -- vim.b.gitsigns_head is set by gitsigns.nvim (already active)
      ---@diagnostic disable-next-line: duplicate-set-field
...
-- Toggle markdown render keymap
vim.keymap.set('n', '<leader>tm', ':RenderMarkdown toggle<CR>', { desc = '[T]oggle [M]arkdown render' })
