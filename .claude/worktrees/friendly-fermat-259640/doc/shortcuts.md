...
| `<Esc>` | Close quickfix window (inside quickfix buffer) |
...
| `gr` | Copy relative path to clipboard |
...
| `gp` | Copy current file relative path to clipboard |
| `gP` | Copy current file absolute path to clipboard |
